...
namespace NetMiner.Gather.Control
{
    ...
    public class cGatherTaskList
    {
        ...
        /// 等待的线程
        /// </summary>
        public List<cGatherTaskSplit> WaitingWorkThread
        {
        ...
        /// 等待开始的任务队列
        /// </summary>
        public List<cGatherTask> WaitingTaskList
        {
        ...
        /// 正在执行的任务队列
        /// </summary>
        public List<cGatherTask> RunningTaskList
        {
        ...
        /// 处于停止状态的任务队列
        /// </summary>
        public List<cGatherTask> StoppedTaskList
        {
        ...
        /// 已完成的任务队列
        /// </summary>
        public List<cGatherTask> CompletedTaskList
        {
        ...
        internal void OverTask(cGatherTask task)
        {
            if (task.TaskState != cGlobalParas.TaskState.Started && task.TaskState != cGlobalParas.TaskState.Waiting
                && task.TaskState != cGlobalParas.TaskState.Running)
            {
                task.OverTask();
            }
        }
