...
namespace NetMiner.Gather.Task.Entity
{
    public class cWebpageCutFlag
    {
        ...
        private bool m_IsAutoDownloadImage;
        public bool IsAutoDownloadImage
        {
            get { return m_IsAutoDownloadImage; }
            set { m_IsAutoDownloadImage = value; }
        }

        //以下为3.11所加

        //以下为V5.0增加
        private bool m_IsAutoFirstImage;
        public bool IsAuthoFirstImage
        {
            get { return m_IsAutoFirstImage; }
            set { m_IsAutoFirstImage = value; }
        }
    }
}
