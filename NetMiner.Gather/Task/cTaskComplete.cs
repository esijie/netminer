...
namespace NetMiner.Gather.Task
{
    public class cTaskComplete
    {
        ...
        public cTaskComplete(string workPath)
        {
            m_workPath = workPath;
        }
        ...
        //返回的是已经完成的任务的集合信息
        public void LoadTaskData(string tPath)
        {
            try
            {
                xmlConfig = new cXmlIO(tPath + "Data\\index.xml");
            }
        ...
        public string GetCompleteDate(int index)
        {
            string cDate = Tasks[index].Row["CompleterDate"].ToString();
            return cDate;
        }
        ...
        public Int64 InsertTaskComplete(Int64 TaskID,cGlobalParas.GatherResult tSate)
        {
            ...
            Task.cTaskRun t = new Task.cTaskRun(m_workPath);
            ...
            txml += "<CompleterDate>" + System.DateTime.Now.ToString () + "</CompleterDate>";
