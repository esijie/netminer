...
namespace SoukeyService
{
    ...
    {
        #region 定义变量
      // public static readonly string MyCmsConn = "Data Source=.;Initial Catalog=mycms;Persist Security Info=False;User ID=sa;Password=feiw;Max Pool Size=300";
   //     public static readonly string MyCmsConn = "Data Source=127.0.0.1;Initial Catalog=mycms;Persist Security Info=False;User ID=sa;Password=zaijinan1;Max Pool Size=300";
