...
namespace NetMiner.Data.Access
{
    public class SQLHelper
    {
        ...
        /// <param name="commandParameters">参数数组</param>
        /// <returns>返回值</returns>
        public static int RunProcedure(string connectionString, CommandType cmdType, string cmdText, params OleDbParameter[] commandParameters)
        {
            OleDbCommand cmd = new OleDbCommand();
            using (OleDbConnection conn = new OleDbConnection(connectionString))
            {
        ...
        /// <param name="commandParameters">参数数组</param>
        /// <returns>返回值</returns>
        public static int RunProcedure(string connectionString, string cmdText, params OleDbParameter[] commandParameters)
        {
            OleDbCommand cmd = new OleDbCommand();
            using (OleDbConnection conn = new OleDbConnection(connectionString))
            {
        ...
        /// <returns>受影响的行数</returns>
        public static int ExecuteNonQueryTrans(string cmdText, params OleDbParameter[] commandParameters)
        {
            using (OleDbConnection conn = new OleDbConnection(MyCmsConn))
            {
                OleDbCommand cmd = new OleDbCommand();
                conn.Open();
        ...
        /// <param name="commandParameters">参数数组</param>
        /// <returns>受影响的行数</returns>
        public static int ExecuteNonQueryTrans(CommandType cmdType, string cmdText, params OleDbParameter[] commandParameters)
        {
        ...
        public static OleDbDataReader ExecuteReader(string connectionString, CommandType cmdType, string cmdText, params OleDbParameter[] commandParameters)
        {
            ...
            {
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters);
                OleDbDataReader rdr = cmd.ExecuteReader(CommandBehavior.CloseConnection);//这保证关闭连接
                cmd.Parameters.Clear();
                return rdr;
            }
            catch
        ...
        /// <param name="commandParameters">参数数组</param>
        /// <returns>DataSet对象</returns>
        public static DataSet ExecuteDataSet(string connectionString, string cmdText, int PageNow, int Rows, params OleDbParameter[] commandParameters)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                OleDbCommand cmd = new OleDbCommand();
        ...
        /// <returns></returns>
        public static DataTable Pagination(string connectString, string keyfield, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, out int RowCount, bool isRowCount, params OleDbParameter[] paramters)
        {
        ...
        /// <param name="paramters">Sql语句参数</param>
        /// <returns></returns>
        public static DataTable Pagination(string connectString, string keyfield, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, params OleDbParameter[] paramters)
        {
            if (sqlWhere.Trim().Length > 0)
            {
                sqlWhere = " AND " + sqlWhere;
        ...
        /// <param name="paramters">Sql语句参数</param>
        /// <returns></returns>
        public static DataTable Pagination2005(string connectString, string keyfield, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, out int RowCount, bool isRowCount, params OleDbParameter[] paramters)
        {
        ...
        /// <param name="paramters">Sql语句参数</param>
        /// <returns></returns>
        public static DataTable Pagination2005(string connectString, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, params OleDbParameter[] paramters)
        {
            string StrSql = "SELECT * ";
            int StartRecord = 0, EndRecord = 0;
            if (sqlWhere.Trim().Length > 0)
        ...
        /// <param name="paramters">Sql语句参数</param>
        /// <returns></returns>
        public static DataTable Pagination(string connectString, string keyfield, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, out int RowCount, bool isRowCount, List<OleDbParameter> paramters)
        {
        ...
        /// <param name="paramters">Sql语句参数</param>
        /// <returns></returns>
        public static DataTable Pagination(string connectString, string keyfield, string fields, string table, string orderField, string sqlWhere, int pageSize, int pageIndex, List<OleDbParameter> paramters)
        {
            if (paramters != null && paramters.Count > 0)
        ...
        /// <returns></returns>
        public static Dictionary<string, string> GetDataHash(OleDbDataReader TempRead)
        {
            Dictionary<string, string> tempD = null;
        ...
        /// <returns></returns>
        private static string GetCacheKey(string strSql, OleDbParameter[] parameters)
        {
            string strKey = strSql;
            if (parameters != null && parameters.Length > 0)
            {
                foreach (OleDbParameter tempPara in parameters)
                {
