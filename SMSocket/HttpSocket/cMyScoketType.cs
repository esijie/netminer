...
namespace SMSocket.HttpSocket
{
    ...
    /// 接收数据完成回调
    /// </summary>
    public delegate void ReceiveCompleteHandler();

    /// <summary>
    /// 接收完头部信息回调
    /// </summary>
    /// <param name="response"></param>
    public delegate void ReceiveHeaderHandler(MyWebResponse response);

    /// <summary>
    /// 每次接收完数据回调
    /// </summary>
    /// <param name="bytes"></param>
    public delegate void ReceiveEventHandler(byte[] bytes,int bLen);
    #endregion
}
