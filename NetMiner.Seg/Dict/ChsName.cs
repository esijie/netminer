...
namespace NetMiner.Seg.Dict
{
    ...
    class ChsName
    {
        ...
        private void LoadNameDict(string fileName, ref Dictionary<char, char> dict)
        {
        ...
        public void LoadChsName(string sPath)
        {
            string dictPath = sPath;

            LoadNameDict(dictPath + "\\ChsSingleName.txt", ref _SingleNameDict);
            LoadNameDict(dictPath + "\\ChsDoubleName1.txt", ref _DoubleName1Dict);
            LoadNameDict(dictPath + "\\ChsDoubleName1.txt", ref _DoubleName2Dict);
        }
