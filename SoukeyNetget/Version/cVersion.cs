...
namespace SoukeyNetget.Version
{
    class cVersion
    {
        ...
        public cGlobalParas.RegisterResult VerfyOnline(string User, string LicenceID)
        {
            ...
            try
            {
                Gather.cGatherWeb g = new SoukeyNetget.Gather.cGatherWeb();
                r = g.GetHtml(Url, cGlobalParas.WebCode.auto, "", "", "", false, false);
                g = null;
            }
        ...
        public cGlobalParas.VerifyUserd VerifyUerd(string User,string LicenceID,string CPUID)
        {
            ...
            try
            {
                Gather.cGatherWeb g = new Gather.cGatherWeb();
                r = g.GetHtml("http://www.yijie.net/verifyUsers.aspx?user=" + User + "&licenceid=" + LicenceID + "&cpuid=" + CPUID, cGlobalParas.WebCode.auto, "", "", "", false, false);
                //string r = g.GetHtml("http://localhost/yijie/verifyUsers.aspx?user=" + User + "&licenceid=" + LicenceID + "&cpuid=" + CPUID, cGlobalParas.WebCode.auto, "", "", "", false, false);
                g = null;
            }
            catch (System.Exception)
            {
