...
namespace SoukeyNetget
{
    public static class cGlobalParas
    {
        ...
        public enum VersionType
        {
            ...
            Personal=3054,      //个人版本    
            Professional=3055,  //专业版
            OpenSource = 3056,    //开源版本
        }
        ...
        static private int ConvertIDByCN(string enumName)
        {
            switch (enumName)
            {
                ...
                case "直接入库，支持大数据量":
                    return (int)TaskRunType.OnlySave;
                ...
                case "外部参数任务":
                    return (int)TaskType.ExternalPara;

                //case "增量采集":
                //    return (int)TaskType.Incremental;

                //case "从头递增":
                //    return (int)IncrByCondition.FormTop;
                //case "从尾递增":
                //    return (int)IncrByCondition.FromEnd;
                ...
                case "根据指定条件删除整行":
                    return (int)ExportLimit.ExportDelData;
                case "必须包含指定条件":
                    return (int)ExportLimit.ExportInclude;
                case "将符合条件的数据置为空":
                    return (int)ExportLimit.ExportSetEmpty;
        ...
        static private int ConvertIDByEN(string enumName)
        {
            switch (enumName)
            {
                ...
                case "Collection and Publish":
                    return (int)TaskRunType.GatherExportData;
                case "Store To support large data":
                    return (int)TaskRunType.OnlySave;
                ...
                case "Ajax ":
                    return (int)TaskType.AjaxHtmlByUrl;
                case "External parameters":
                    return (int)TaskType.ExternalPara;
                //case "Incremental collection":
                //    return (int)TaskType.Incremental;

                //case "From the top of incremental":
                //    return (int)IncrByCondition.FormTop ;
                //case "From the end of incremental":
                //    return (int)IncrByCondition.FromEnd ;
                ...
                case "Replace use Regex":
                    return (int)ExportLimit.ExportRegexReplace;
                case "Del rows by condition":
                    return (int)ExportLimit.ExportDelData;
                case "Include by condition":
                    return (int)ExportLimit.ExportInclude;
                case "Set empty by condition":
                    return (int)ExportLimit.ExportSetEmpty;
        ...
        static public string  ConvertName(int CustomType)
        {
            ...
            switch (CustomType)
            {
                ...
                case (int)TaskRunType.GatherExportData :
                    ...
                    break ;
                case (int)TaskRunType.OnlySave :
                    str = rm.GetString("TaskRunType3").ToString();
                    break;
                ...
                case (int)TaskType.AjaxHtmlByUrl :
                    ...
                    break;
                case (int)TaskType.ExternalPara:
                    str = rm.GetString("TaskType6").ToString();
                    break;
                //case (int)TaskType.Incremental :
                //    str = rm.GetString("TaskType5").ToString();
                //    break;

                //case (int)IncrByCondition.FormTop  :
                //    str = rm.GetString("IncrByCondition1").ToString();
                //    break;
                //case (int)IncrByCondition.FromEnd :
                //    str = rm.GetString("IncrByCondition2").ToString();
                //    break;
                ...
                case (int)ExportLimit.ExportRegexReplace:
                    ...
                    break;
                case (int)ExportLimit.ExportDelData:
                    str = rm.GetString("ExportLimit10").ToString();
                    break;
                case (int)ExportLimit.ExportInclude:
                    str = rm.GetString("ExportLimit11").ToString();
                    break;
                case (int)ExportLimit.ExportSetEmpty:
                    str = rm.GetString("ExportLimit12").ToString();
                    break;
