...
namespace NetMinerHttpHelp
{
    public class HttpHelp
    {
        public static NetMinerHttpHelp.Net.HttpWebRequest request = null;
        public static string GetHtml(string url,Method m,string postData,NetMinerHttpHelp.Net.enCodingCode pCode,
            ref string cookie,string headers,ProxyType proxyType,string proxyAddress,int proxyPort,out string repHeaders )
        {

            request = NetMinerHttpHelp.Net.HttpWebRequest.Create(new Uri(url), request, true);
            ...
            if (m==NetMinerHttpHelp.Net.Method.POST )
            {
                ...
                request.method = NetMinerHttpHelp.Net.Method.POST;
            }
            else
                request.method = NetMinerHttpHelp.Net.Method.GET;
            ...
            #region  开始请求代码
            NetMinerHttpHelp.Net.HttpWebResponse wResp = null;
            ...
            try
            {
                ...
                if (pCode == enCodingCode.auto && wResp.CharacterSet != "")
                {
                ...
                else
                {
                    switch (pCode)
                    {
                        ...
                        case enCodingCode.big5:
                            ...
                            break;
                        case enCodingCode.gb2312:
                            webCode = Encoding.GetEncoding("gb2312");
                            break;
                        case enCodingCode.gbk:
                            webCode = Encoding.GetEncoding("gbk");
                            break;
                        case enCodingCode.NoCoding:
                            webCode = Encoding.Default;
                            break;
