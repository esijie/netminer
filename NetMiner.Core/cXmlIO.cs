...
namespace NetMiner.Core
{
    public class cXmlIO
    {
        ...
        public void EditTaskrunValue(string TaskID,cGlobalParas.TaskState tState, string GUrlCount,
            string GUrlNaviCount, string GErrUrlCount,string GErrUrlNaviCount, string UrlNaviCount)
        {
            ...
            for (int i = 0; i < nodes.Count; i++)
            {
                for (int j = 0; j < nodes[i].ChildNodes.Count; j++)
                {
                    ...
                    if (nodes[i].ChildNodes[j].Name == "TaskID" && nodes[i].ChildNodes[j].InnerText == TaskID)
                    {
                        ...
                        nod = nodes[i].SelectSingleNode("UrlNaviCount");
                        nod.InnerText = UrlNaviCount;
                        nod=null;
                        ...
                        nod = nodes[i].SelectSingleNode("GatheredUrlNaviCount");
                        nod.InnerText = GUrlNaviCount;
                        nod=null;
                        ...
                        nod = nodes[i].SelectSingleNode("ErrUrlNaviCount");
                        nod.InnerText = GErrUrlNaviCount;
                        nod = null;
