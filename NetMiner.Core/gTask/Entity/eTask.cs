...
namespace NetMiner.Core.gTask.Entity
{
    ...
    public class eTask
    {
        ...
        public eTask()
        {
            this.WebpageLink = new List<eWebLink>();
            this.WebpageCutFlag = new List<eWebpageCutFlag>();
            this.TriggerTask = new List<eTriggerTask>();
            this.Headers = new List<eHeader>();
            this.PublishParas = new List<ePublishData>();
            this.ThreadProxy = new List<eThreadProxy>();
        }
        ...
        /// <summary>
        /// 注意：此为深拷贝，即复制出另外一个对象出来
        /// </summary>
        /// <returns></returns>
        public eTask DeepClone()
        {

            return NetMiner.Base.Tool.DeepCopyWithReflection<eTask>(this);
        }
        ...
        private cGlobalParas.TaskClass m_TaskClass;
        public cGlobalParas.TaskClass TaskClass
        {
        ...
        //从V5.5开始取消任务中的分类记录信息，无意义，且占用了大量的操作资源
        ...
        public cGlobalParas.GetCookieType CookieType { get; set; }

        public string LoginReferUrl { get; set; }
        ...
        public int ChangeCookieByPage { get; set; }
        ...
        private List<eWebLink> m_WebpageLink;
        public List<eWebLink> WebpageLink
        {
            get { return m_WebpageLink; }
            set { m_WebpageLink = value; }
        }

        private List<eWebpageCutFlag> m_WebpageCutFlag;
        public List<eWebpageCutFlag> WebpageCutFlag
        {
        ...
        private bool m_isCloseTab;
        public bool isCloseTab
        {
            get { return m_isCloseTab; }
            set { m_isCloseTab = value; }
        }
